...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  UIImage *playImage = paused ?
      [UIImage imageNamed:@"media_play" inBundle:bundle compatibleWithTraitCollection:nil]
    : [UIImage imageNamed:@"media_pause" inBundle:bundle compatibleWithTraitCollection:nil];
...
- (IBAction)disconnectDevice:(id)sender {
    [_delegate.deviceManager stopApplication];
...
- (void)playPausePressed:(id)sender {
  ...
  UIImage *playImage =
      (paused ? [UIImage imageNamed:@"media_play" inBundle:bundle compatibleWithTraitCollection:nil]
       : [UIImage imageNamed:@"media_pause" inBundle:bundle compatibleWithTraitCollection:nil]);
  [button setBackgroundImage:playImage forState:UIControlStateNormal];
}
