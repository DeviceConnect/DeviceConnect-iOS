//
//  DPLinkingDeviceAtmosphericPressureOnce.h
...
@interface DPLinkingDeviceAtmosphericPressureOnce : DPLinkingTimeoutSchedule <DPLinkingDeviceAtmosphericPressureDelegate>
