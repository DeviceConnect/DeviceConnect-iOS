...
- (void)viewDidLoad
{
    ...
    SonyCameraDataViewController *startingViewController
            = [self.SonyCameraModelController viewControllerAtIndex:0 storyboard:self.storyboard];
                   ...
                   spineLocationForInterfaceOrientation:(UIInterfaceOrientation)orientation
{
    ...
    NSUInteger indexOfCurrentViewController
            = [self.SonyCameraModelController indexOfViewController:currentViewController];
    if (indexOfCurrentViewController == 0 || indexOfCurrentViewController % 2 == 0) {
        UIViewController *nextViewController
            = [self.SonyCameraModelController pageViewController:self.pageViewController
