//
//  DPThetaSettingViewController.m
//  dConnectDeviceTheta
//
...
#import "DPThetaSettingViewController.h"

@interface DPThetaSettingViewController () <UIPageViewControllerDataSource>{
    NSArray *_pages;
}

@end

@implementation DPThetaSettingViewController
...
- (void)viewDidLoad
{
    ...
    // 下のドットの色
    UIPageControl *pageControl = [UIPageControl appearanceWhenContainedInInstancesOfClasses:[NSArray arrayWithObject:[self class]]];
    ...
    // ページ準備
    _pages = @[@"AbstractGuide", @"PictureModeGuide", @"MovieModeGuide", @"WifiGuide", @"ConnectedGuide"];
