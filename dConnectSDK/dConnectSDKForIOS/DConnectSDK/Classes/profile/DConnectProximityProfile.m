...
- (BOOL) didReceiveGetRequest:(DConnectRequestMessage *)request response:(DConnectResponseMessage *)response {
    ...
    if (attribute && [attribute localizedCaseInsensitiveCompare: DConnectProximityProfileAttrOnDeviceProximity] == NSOrderedSame) {
    ...
    } else if (attribute && [attribute localizedCaseInsensitiveCompare: DConnectProximityProfileAttrOnUserProximity] == NSOrderedSame) {
