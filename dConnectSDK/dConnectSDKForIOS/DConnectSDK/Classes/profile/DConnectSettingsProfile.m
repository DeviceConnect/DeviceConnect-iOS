...
- (BOOL) didReceiveGetRequest:(DConnectRequestMessage *)request response:(DConnectResponseMessage *)response {
    ...
    if (interface) {
        if (interface && [interface localizedCaseInsensitiveCompare:DConnectSettingsProfileInterfaceSound] == NSOrderedSame &&
            attribute && [attribute localizedCaseInsensitiveCompare: DConnectSettingsProfileAttrVolume] == NSOrderedSame)
        {
        ...
        } else if (interface && [interface localizedCaseInsensitiveCompare: DConnectSettingsProfileInterfaceDisplay] == NSOrderedSame) {
            if (attribute && [attribute localizedCaseInsensitiveCompare: DConnectSettingsProfileAttrLight] == NSOrderedSame) {
    ...
    } else if (attribute && [attribute localizedCaseInsensitiveCompare: DConnectSettingsProfileAttrDate] == NSOrderedSame) {
